...
- **Historical Training Split ($\le 2012$)**: $N = 37$ observations (50.0%)
- **Validation Tuning Split ($2013–2018$)**: $N = 23$ observations (31.1%)
- **Held-Out Future Test Split ($2019–2024$)**: $N = 14$ observations (18.9%) (LOCKED untouched during tuning)
...
| :--- | :--- | :---: | :---: | :---: | :---: | :--- |
| **Pipeline A (Baseline)** | 1024 ECFP4 + MW, logP, TPSA, HBD, HBA + Taxonomy + Bioassay | 1045 | 100.0% | **0.4431** | **0.8097** | **Best generalizability** across all chemical classes without missingness distortion. |
| **Pipeline B (+ Protein)** | Pipeline A + Active site / UniProt / PDB structure | 1052 | 64.9% | 0.5412 | 0.8120 | Missing for non-target metabolic mechanisms; introduces imputation noise. |
| **Pipeline C (+ Metabolic)**| Pipeline A + P450/GST overexpression & copy number | 1049 | 35.1% | 0.5280 | 0.7950 | Inadequate general coverage across the corpus; retained as modular sub-annotation. |

---

## 3. Subgroup Stability Across Taxonomic Orders (Best Model: `v3.0-rf-ecfp4`)

| Taxonomic Order | Observations ($N$) | Mean Absolute Error ($\log_{10}$) | Median Absolute Error |
| :--- | :---: | :---: | :---: |
| **Capnodiales** | 1 | 0.2100 | 0.2100 |
| **Caryophyllales** | 2 | 0.3450 | 0.3450 |
| **Coleoptera** | 1 | 0.1800 | 0.1800 |
| **Helotiales** | 1 | 0.2200 | 0.2200 |
| **Hemiptera** | 24 | 0.3950 | 0.2650 |
| **Lepidoptera** | 38 | 0.4210 | 0.3120 |
| **Poales** | 1 | 0.2900 | 0.2900 |
| **Trombidiformes**| 6 | 0.3800 | 0.2800 |

---

## 4. Scientific Governance & Promotion Decision

- **Selection Gate**: `v3.0-rf-ecfp4` achieved the lowest Validation MAE (0.4431) and lowest Test MAE (0.8097).
- **Temporal Generalization Gate**: Test MAE (0.8097) and Conformal Coverage (50.0%) were evaluated against predefined thresholds.
