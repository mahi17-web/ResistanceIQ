...
function MolecularLatticeBg() {
  return (
    ...
    >
      ...
      <path
        d="M 70 80 L 130 45 L 190 80 L 190 150 L 130 185 L 70 150 Z"
        stroke="url(#bondGrad)"
        strokeWidth="1.2"
        strokeDasharray="3 3"
      />
      <path
        d="M 190 80 L 250 45 L 310 80 L 310 150 L 250 185 L 190 150"
        stroke="url(#bondGrad)"
        strokeWidth="1.2"
      />
      <path
        d="M 310 80 L 370 45 L 430 80 L 430 150 L 370 185 L 310 150"
        stroke="url(#bondGrad)"
        strokeWidth="1.2"
        strokeDasharray="2 2"
      />
      <path
        d="M 130 185 L 130 255 L 190 290 L 250 255 L 250 185"
        stroke="url(#bondGrad)"
        strokeWidth="1.2"
      />
      <path
        d="M 250 255 L 310 290 L 370 255 L 370 185"
        stroke="url(#bondGrad)"
        strokeWidth="1.2"
        strokeDasharray="4 2"
      />
      ...
      {/* Trajectory lines */}
      <line x1="190" y1="80" x2="250" y2="255" stroke="#38BDF8" strokeWidth="0.8" strokeOpacity="0.25" />
      <line x1="130" y1="185" x2="370" y2="185" stroke="#0BDFA0" strokeWidth="0.8" strokeOpacity="0.2" strokeDasharray="4 4" />

      {/* Molecular Atoms / Nodes */}
      <circle cx="70" cy="80" r="3.5" fill="#0BDFA0" />
      <circle cx="130" cy="45" r="4" fill="#38BDF8" />
      <circle cx="190" cy="80" r="4.5" fill="#0BDFA0" />
      <circle cx="190" cy="150" r="3.5" fill="#8B8CF8" />
      <circle cx="130" cy="185" r="4" fill="#0BDFA0" />
      <circle cx="70" cy="150" r="3.5" fill="#F3B14D" />

      <circle cx="250" cy="45" r="4" fill="#8B8CF8" />
      <circle cx="310" cy="80" r="4.5" fill="#0BDFA0" />
      <circle cx="310" cy="150" r="4" fill="#38BDF8" />
      <circle cx="250" cy="185" r="5" fill="#0BDFA0" />

      <circle cx="370" cy="45" r="3.5" fill="#38BDF8" />
      <circle cx="430" cy="80" r="3.5" fill="#8B8CF8" />
      <circle cx="430" cy="150" r="3.5" fill="#0BDFA0" />
      <circle cx="370" cy="185" r="4" fill="#F3B14D" />

      <circle cx="130" cy="255" r="3.5" fill="#38BDF8" />
      <circle cx="190" cy="290" r="4.5" fill="#0BDFA0" />
      <circle cx="250" cy="255" r="4" fill="#8B8CF8" />
      <circle cx="310" cy="290" r="3.5" fill="#0BDFA0" />
      <circle cx="370" cy="255" r="3.5" fill="#38BDF8" />

      {/* Target Core Glow */}
      <circle cx="250" cy="185" r="16" fill="url(#nodeGlow)" />
    </svg>
  );
}
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#05070B] text-[#F1F5F9] font-sans antialiased overflow-x-hidden selection:bg-[#0BDFA0]/20 selection:text-[#0BDFA0]">
      {/* ─── 1. Header (Sticky 68px Clean Glass Header) ──────────────── */}
      <header className="sticky top-0 z-50 h-[68px] border-b border-white/[0.07] bg-[#05070B]/90 backdrop-blur-xl">
        <div className="w-full max-w-[1440px] xl:max-w-[1500px] mx-auto h-full px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16 flex items-center justify-between">
          {/* Brand */}
          <Link
            to="/"
          ...
          >
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-[16.5px] font-bold tracking-tight text-[#F1F5F9] group-hover:text-white transition-colors">
          ...
          <nav className="hidden lg:flex items-center gap-8 text-[13.5px] font-medium text-[#9AACBE]">
          ...
          <div className="hidden sm:flex items-center gap-4 flex-shrink-0">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 h-10 px-4.5 rounded-lg bg-[#0BDFA0] hover:bg-[#09c78e] text-[#020609] text-[13px] font-bold tracking-wide transition-all duration-200 shadow-[0_0_15px_rgba(11,223,160,0.25)] hover:shadow-[0_0_25px_rgba(11,223,160,0.4)] cursor-pointer"
            >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#0B1017] border-b border-white/10 px-6 py-6 space-y-4 text-sm font-medium text-[#9AACBE]">
      ...
      <section className="relative pt-16 sm:pt-20 lg:pt-24 pb-16 lg:pb-20">
        ...
        <div className="w-full max-w-[1440px] xl:max-w-[1500px] mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-6 xl:col-span-6 flex flex-col justify-center">
              ...
              {/* Main Heading */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[52px] xl:text-[58px] font-extrabold tracking-tight text-white leading-[1.08] mb-6 max-w-[650px]">
              ...
              {/* Description */}
              <p className="text-base sm:text-lg text-[#9AACBE] leading-[1.6] mb-8 max-w-[620px]">
              ...
              <div className="mb-8 max-w-[620px]">
                ...
                <div className="flex flex-wrap items-center gap-2 text-xs font-mono font-semibold">
                  <span className="px-2.5 py-1 rounded-md bg-white/[0.04] text-[#0BDFA0] border border-[#0BDFA0]/20">CROP</span>
                  <span className="text-[#7C8A9A]">→</span>
                  <span className="px-2.5 py-1 rounded-md bg-white/[0.04] text-[#38BDF8] border border-[#38BDF8]/20">THREAT</span>
                  <span className="text-[#7C8A9A]">→</span>
                  <span className="px-2.5 py-1 rounded-md bg-white/[0.04] text-[#8B8CF8] border border-[#8B8CF8]/20">TARGET</span>
                  <span className="text-[#7C8A9A]">→</span>
                  <span className="px-2.5 py-1 rounded-md bg-white/[0.04] text-violet-300 border border-violet-400/20">PROTEIN</span>
                  <span className="text-[#7C8A9A]">→</span>
                  <span className="px-2.5 py-1 rounded-md bg-white/[0.04] text-amber-300 border border-amber-400/20">MOLECULE</span>
                  <span className="text-[#7C8A9A]">→</span>
                  <span className="px-2.5 py-1 rounded-md bg-[#0BDFA0]/20 text-[#0BDFA0] font-bold border border-[#0BDFA0]/40">FORECAST</span>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <button
                  onClick={handleOpenWorkspace}
                  className="inline-flex items-center justify-center gap-2.5 h-12 px-6 rounded-xl bg-[#0BDFA0] hover:bg-[#09c78e] text-[#020609] text-sm font-bold tracking-wide transition-all duration-200 shadow-[0_0_20px_rgba(11,223,160,0.3)] hover:shadow-[0_0_30px_rgba(11,223,160,0.5)] transform hover:-translate-y-0.5 cursor-pointer"
                >
                  <span>Open Workspace</span>
                  <ArrowRight size={16} />
                </button>
                ...
                <a
                  href="#capabilities"
                  className="inline-flex items-center justify-center gap-2 h-12 px-6 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] border border-white/10 hover:border-white/20 text-[#F1F5F9] text-sm font-semibold transition-all duration-200"
                >
            ...
            {/* ─── RIGHT COLUMN (48% - Live Inference Console) ─── */}
            <div className="lg:col-span-6 xl:col-span-6 relative">
              ...
              <div className="relative min-h-[520px] rounded-[20px] border border-white/12 bg-[#0B1017] p-6 sm:p-7 shadow-[0_30px_70px_rgba(0,0,0,0.9)] overflow-hidden group flex flex-col justify-between">
                ...
                <div className="relative z-10 space-y-5">
                  ...
                  <div className="flex items-center gap-2 p-1 rounded-lg bg-[#05070B] border border-white/[0.06] text-xs font-mono overflow-x-auto">
                    <button
                  ...
                  <div className="p-4 rounded-xl bg-[#05070B]/90 border border-white/[0.06] backdrop-blur-sm">
                    ...
                    <div className="text-lg font-bold text-white mb-0.5">{activeDemo.name}</div>
                    <div className="text-xs text-[#9AACBE] mb-2.5">{activeDemo.classification} · <span className="text-[#38BDF8]">{activeDemo.moa}</span></div>
                    <div className="p-2.5 rounded bg-black/50 border border-white/[0.04] font-mono text-[10.5px] text-[#7C8A9A] break-all leading-tight">
                      <span className="text-[#38BDF8]">SMILES:</span> {activeDemo.smiles}
                    </div>
                  </div>

                  {/* Target & Organism Cards (Side by Side) */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                    <div className="p-4 rounded-xl bg-[#05070B]/90 border border-white/[0.06] min-h-[100px] flex flex-col justify-between">
                  ...
                  {/* Predictive ML Output Section (4 Columns on Desktop) */}
                  <div className="p-4 rounded-xl bg-gradient-to-b from-white/[0.04] to-transparent border border-white/[0.08]">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      ...
                      <div className="p-3 rounded-lg bg-[#05070B] border border-white/[0.05]">
                        ...
                        <div className="text-xl font-bold font-mono text-[#0BDFA0] mt-1">
                      ...
                      <div className="p-3 rounded-lg bg-[#05070B] border border-white/[0.05]">
                        ...
                        <div className="text-xs font-bold font-mono text-[#8B8CF8] mt-1.5 truncate" title={activeDemo.conformal90}>
                      ...
                      <div className="p-3 rounded-lg bg-[#05070B] border border-white/[0.05]">
                        ...
                        <div className="text-xs font-bold font-mono text-white mt-1.5" style={{ color: activeDemo.riskColor }}>
                          {activeDemo.riskLevel}
                        </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[10px] font-mono text-[#7C8A9A]">
          ...
          <div className="mt-16 pt-10 border-t border-white/[0.08]">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              <div className="p-6 rounded-xl bg-[#0B1017] border border-white/[0.07] min-h-[120px] flex flex-col justify-center">
                <div className="text-2xl font-bold font-mono text-[#0BDFA0]">1,059-D</div>
                <div className="text-xs text-[#7C8A9A] font-mono uppercase tracking-wider mt-1">FEATURE DIMENSIONS</div>
                <div className="text-[11px] text-[#9AACBE] mt-1">Multi-modal descriptor vectors</div>
              </div>

              <div className="p-6 rounded-xl bg-[#0B1017] border border-white/[0.07] min-h-[120px] flex flex-col justify-center">
                <div className="text-2xl font-bold font-mono text-[#8B8CF8]">2,048-BIT</div>
                <div className="text-xs text-[#7C8A9A] font-mono uppercase tracking-wider mt-1">ECFP4 FINGERPRINTS</div>
                <div className="text-[11px] text-[#9AACBE] mt-1">Morgan circular radius 2</div>
              </div>

              <div className="p-6 rounded-xl bg-[#0B1017] border border-white/[0.07] min-h-[120px] flex flex-col justify-center">
                <div className="text-2xl font-bold font-mono text-[#38BDF8]">90% BOUNDS</div>
                <div className="text-xs text-[#7C8A9A] font-mono uppercase tracking-wider mt-1">CONFORMAL COVERAGE</div>
                <div className="text-[11px] text-[#9AACBE] mt-1">Inductive conformal guarantees</div>
              </div>

              <div className="p-6 rounded-xl bg-[#0B1017] border border-white/[0.07] min-h-[120px] flex flex-col justify-center">
                <div className="text-2xl font-bold font-mono text-[#F3B14D]">TANIMOTO</div>
                <div className="text-xs text-[#7C8A9A] font-mono uppercase tracking-wider mt-1">MOLECULAR SIMILARITY</div>
                <div className="text-[11px] text-[#9AACBE] mt-1">Manifold distance gating</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ─── 3. About Section (Spacious 100px Top/Bottom Padding) ──────── */}
      <section id="about" className="py-24 lg:py-28 border-t border-white/[0.06] bg-[#070B10]">
        <div className="w-full max-w-[1440px] xl:max-w-[1500px] mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
          <div className="text-center max-w-[850px] mx-auto mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[44px] font-bold text-white tracking-tight mt-3 mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-[#0B1017] border border-white/[0.07] hover:border-[#0BDFA0]/30 transition-all min-h-[220px] flex flex-col justify-between group">
              <div>
                <div className="w-11 h-11 rounded-xl bg-[#0BDFA0]/10 text-[#0BDFA0] flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
                  <Database size={22} />
                </div>
            ...
            <div className="p-8 rounded-2xl bg-[#0B1017] border border-white/[0.07] hover:border-[#8B8CF8]/30 transition-all min-h-[220px] flex flex-col justify-between group">
              <div>
                <div className="w-11 h-11 rounded-xl bg-[#8B8CF8]/10 text-[#8B8CF8] flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
                  <Cpu size={22} />
                </div>
            ...
            <div className="p-8 rounded-2xl bg-[#0B1017] border border-white/[0.07] hover:border-[#38BDF8]/30 transition-all min-h-[220px] flex flex-col justify-between group">
              <div>
                <div className="w-11 h-11 rounded-xl bg-[#38BDF8]/10 text-[#38BDF8] flex items-center justify-center mb-5 group-hover:scale-105 transition-transform">
                  <ShieldCheck size={22} />
                </div>
      ...
      <section id="capabilities" className="py-24 lg:py-28 border-t border-white/[0.06] bg-[#05070B]">
        <div className="w-full max-w-[1440px] xl:max-w-[1500px] mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
          <div className="text-center max-w-[850px] mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
            <div className="p-8 rounded-2xl bg-[#0B1017] border border-white/[0.07] hover:border-[#0BDFA0]/40 transition-all flex flex-col justify-between group">
              <div>
            ...
            <div className="p-8 rounded-2xl bg-[#0B1017] border border-white/[0.07] hover:border-[#8B8CF8]/40 transition-all flex flex-col justify-between group">
              <div>
            ...
            <div className="p-8 rounded-2xl bg-[#0B1017] border border-white/[0.07] hover:border-[#38BDF8]/40 transition-all flex flex-col justify-between group">
              <div>
            ...
            <div className="p-8 rounded-2xl bg-[#0B1017] border border-white/[0.07] hover:border-[#F3B14D]/40 transition-all flex flex-col justify-between group">
              <div>
      ...
      <section id="workflow" className="py-24 lg:py-28 border-t border-white/[0.06] bg-[#070B10]">
        <div className="w-full max-w-[1440px] xl:max-w-[1500px] mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
          <div className="text-center max-w-[850px] mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            <div className="p-5 rounded-xl bg-[#0B1017] border border-white/[0.07] text-center flex flex-col items-center justify-between min-h-[160px]">
              ...
              <Sprout size={20} className="text-[#0BDFA0] mb-2" />
            ...
            <div className="p-5 rounded-xl bg-[#0B1017] border border-white/[0.07] text-center flex flex-col items-center justify-between min-h-[160px]">
              ...
              <Bug size={20} className="text-[#38BDF8] mb-2" />
            ...
            <div className="p-5 rounded-xl bg-[#0B1017] border border-white/[0.07] text-center flex flex-col items-center justify-between min-h-[160px]">
              ...
              <Atom size={20} className="text-[#8B8CF8] mb-2" />
            ...
            <div className="p-5 rounded-xl bg-[#0B1017] border border-white/[0.07] text-center flex flex-col items-center justify-between min-h-[160px]">
              ...
              <Dna size={20} className="text-violet-300 mb-2" />
            ...
            <div className="p-5 rounded-xl bg-[#0B1017] border border-white/[0.07] text-center flex flex-col items-center justify-between min-h-[160px]">
              ...
              <FlaskConical size={20} className="text-amber-300 mb-2" />
            ...
            <div className="p-5 rounded-xl bg-[#0B1017] border border-white/[0.07] text-center flex flex-col items-center justify-between min-h-[160px]">
              ...
              <Compass size={20} className="text-cyan-300 mb-2" />
              <div className="text-sm font-bold text-white">06 REVIEW</div>
              <div className="text-[11px] text-[#7C8A9A] mt-1">Tanimoto OOD Filter</div>
            </div>

            <div className="p-5 rounded-xl bg-[#0BDFA0]/10 border border-[#0BDFA0]/30 text-center flex flex-col items-center justify-between min-h-[160px]">
              ...
              <BarChart3 size={20} className="text-[#0BDFA0] mb-2" />
      ...
      <section id="ml-engine" className="py-24 lg:py-28 border-t border-white/[0.06] bg-[#05070B]">
        <div className="w-full max-w-[1440px] xl:max-w-[1500px] mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
          <div className="text-center max-w-[850px] mx-auto mb-16">
          ...
          <div className="p-8 sm:p-10 rounded-2xl bg-[#0B1017] border border-white/10 space-y-8">
            {/* Architecture Pipeline Cards */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 text-center">
              <div className="p-5 rounded-xl bg-[#05070B] border border-white/[0.06] min-h-[130px] flex flex-col justify-center">
              ...
              <div className="p-5 rounded-xl bg-[#0BDFA0]/10 border border-[#0BDFA0]/30 min-h-[130px] flex flex-col justify-center">
            ...
            {/* Model Metadata */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pt-6 border-t border-white/[0.06] text-xs font-mono text-[#9AACBE]">
              <div className="p-4 rounded-xl bg-[#05070B] border border-white/[0.04]">
      ...
      <section id="molecular" className="py-24 lg:py-28 border-t border-white/[0.06] bg-[#070B10]">
        <div className="w-full max-w-[1440px] xl:max-w-[1500px] mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
          <div className="text-center max-w-[850px] mx-auto mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div className="lg:col-span-7 space-y-5">
              <div className="p-6 rounded-2xl bg-[#0B1017] border border-white/[0.07]">
            ...
            <div className="lg:col-span-5 p-7 rounded-2xl bg-[#05070B] border border-white/10 space-y-4 font-mono text-xs">
              ...
              <div className="space-y-3 text-[#9AACBE]">
      ...
      <section id="governance" className="py-24 lg:py-28 border-t border-white/[0.06] bg-[#05070B]">
        <div className="w-full max-w-[1440px] xl:max-w-[1500px] mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            {/* Scientific Governance */}
            <div className="p-8 sm:p-9 rounded-2xl bg-[#0B1017] border border-white/10">
              ...
              <p className="text-xs text-[#7C8A9A] mt-5 leading-relaxed">
      ...
      <section className="py-24 lg:py-28 border-t border-white/[0.06] bg-[#070B10] text-center relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[350px] bg-[#0BDFA0]/10 blur-[150px] rounded-full pointer-events-none -z-10" />
        ...
        <div className="w-full max-w-[1440px] xl:max-w-[1500px] mx-auto px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16">
          <div className="max-w-[850px] mx-auto space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              <button
                onClick={handleOpenWorkspace}
                className="inline-flex items-center gap-2.5 h-12 px-7 rounded-xl bg-[#0BDFA0] hover:bg-[#09c78e] text-[#020609] text-sm font-bold tracking-wide transition-all shadow-[0_0_25px_rgba(11,223,160,0.35)] hover:shadow-[0_0_35px_rgba(11,223,160,0.55)] cursor-pointer"
              >
                <span>Open Workspace</span>
                <ArrowRight size={16} />
              </button>
              ...
              <Link
                to="/register"
                className="inline-flex items-center gap-2 h-12 px-7 rounded-xl bg-white/[0.05] hover:bg-white/[0.09] border border-white/10 text-white text-sm font-semibold transition-all"
              >
